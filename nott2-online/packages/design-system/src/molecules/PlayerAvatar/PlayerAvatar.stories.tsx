...
const meta: Meta<typeof PlayerAvatar> = {
  ...
  tags: ['autodocs'],
  args: { name: 'Alice', suit: 'Spades', characterName: 'The Jock', isConnected: true },
};
export default meta;
type Story = StoryObj<typeof PlayerAvatar>;

export const Default: Story = {};
export const Hearts: Story = { args: { name: 'Bob', suit: 'Hearts', characterName: 'The Final Girl' } };
export const Clubs: Story = { args: { name: 'Carol', suit: 'Clubs', characterName: 'The Nerd' } };
export const Diamonds: Story = { args: { name: 'Dave', suit: 'Diamonds', characterName: 'The Rebel' } };

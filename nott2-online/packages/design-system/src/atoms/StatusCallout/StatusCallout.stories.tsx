...
export const Highlight: Story = { args: { variant: 'highlight', icon: 'theater_comedy',  children: 'Spades must rise to the challenge — the Ace of Spades demands it.' } };
...
export const AllVariants: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      <StatusCallout variant="highlight" icon="theater_comedy" >Alex must rise to the challenge — the Ace of Spades demands it.</StatusCallout>
    </div>
  ),
};

...
const classes = computed(() => {
  ...
  if (props.as === 'span') base.push('inline');
  else {
    base.push('block');
  ...
  if (props.variant === 'hero')
    base.push('font-display uppercase tracking-widest text-6xl md:text-8xl');
  if (props.variant === 'h1')
    base.push('font-display uppercase tracking-widest text-4xl md:text-6xl');
  if (props.variant === 'h2')
    base.push('font-display uppercase tracking-widest text-2xl md:text-4xl');

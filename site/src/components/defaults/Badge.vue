...
<template>
  <span 
    class="inline-flex items-center px-2.5 py-0.5 rounded text-xs font-display uppercase tracking-widest"
    :class="{
      ...
      'bg-nott-green/10 text-nott-green border border-nott-green/30': variant === 'success'
    }"
  >
    <slot />
  </span>
